...
final class ShopProductsQueryBuilder implements QueryBuilderInterface
{
    ...
    public function __construct(
        ...
        QueryBuilderInterface $hasBrandsQueryBuilder,
        ...
        $this->hasBrandsQueryBuilder = $hasBrandsQueryBuilder;
    ...
    public function buildQuery(array $data): AbstractQuery
    {
        ...
        $this->resolveBrandQuery($boolQuery, $data);
    ...
    private function resolveBrandQuery(BoolQuery $boolQuery, array $data): void
    {
        foreach ($data as $key => $value) {
            if (0 === strpos($key, $this->brandPropertyPrefix) && 0 < count($value)) {
                $brandQuery = $this->hasBrandsQueryBuilder->buildQuery(['brand' => $key, 'brands' => $value]);
